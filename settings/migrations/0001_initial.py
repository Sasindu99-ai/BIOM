    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('flag', models.URLField(blank=True, default='', null=True, verbose_name='Flag URL')),
                ('length', models.IntegerField(default=0, verbose_name='Mobile Number Length')),
                ('emoji', models.CharField(default='🏳️', max_length=10, verbose_name='Flag Emoji')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('exchange_rate', models.DecimalField(decimal_places=4, default=1, max_digits=10, verbose_name='Exchange Rate')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('placeId', models.CharField(blank=True, max_length=255, null=True, verbose_name='Place ID')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_type', models.TextField(choices=[('string', 'String'), ('integer', 'Integer'), ('float', 'Float'), ('boolean', 'Boolean'), ('json', 'Json')], default='string')),
            ],
            options={
                'db_table': 'settings',
                'ordering': ['key'],
