        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'name',
                    models.CharField(
                        max_length=255, unique=True, verbose_name='Currency Name',
                    ),
                ),
                ('code', models.CharField(max_length=3, verbose_name='Currency Code')),
                (
                    'symbol',
                    models.CharField(max_length=3, verbose_name='Currency Symbol'),
                ),
                (
                    'exchange_rate',
                    models.DecimalField(
                ...
                (
                    'is_default',
                    models.BooleanField(default=False, verbose_name='Default Currency'),
                ),
                (
                    'is_active',
